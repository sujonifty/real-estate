        ...
        <div>
            ...
            <div className="my-20">
                ...
                <div className="flex flex-col lg:flex-row justify-center items-center">
                    ...
                    <hr className=" w-1/5 border-b-dotted border-4" />
                    <div className="text-left space-y-2 lg:space-y-4">
                ...
                <section className="py-6 dark:bg-gray-300">
                    <div className="container flex flex-col justify-center p-4 mx-auto">
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-4 sm:grid-cols-2">
                            <img className="object-cover w-full dark:bg-gray-500 aspect-square" src="https://i.ibb.co/JHqD4jP/partner-01.png" />
                            <img className="object-cover w-full dark:bg-gray-500 aspect-square" src="https://i.ibb.co/fDh1VNL/partner-02.png" />
                            <img className="object-cover w-full dark:bg-gray-500 aspect-square" src="https://i.ibb.co/DWp0nmF/partner-03.png" />
                            <img className="object-cover w-full dark:bg-gray-500 aspect-square" src="https://i.ibb.co/SJG7LXr/partner-04.png" />
                        </div>
                    </div>
                </section>
            </div>
