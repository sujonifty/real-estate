...
const UpdateProfile = () => {
    const { user,createUpdate } = useContext(authContext);
            ...
            <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-t-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 text-gray-100 bg-[#1d2d42] dark:text-gray-800">
                ...
                <form onSubmit={handleUpdateProfile} className="space-y-6">
                    <div>
                        ...
                        <input name="name" id="name" type="text" placeholder="Your name" className="w-full p-3 rounded dark:bg-gray-100" />
                    </div>
                    <div>
                        <label htmlFor="email" className="text-sm">PhotoURL</label>
                        <input name="photo" id="photo" type="photo" placeholder="Your PhotoURL" className="w-full p-3 rounded dark:bg-gray-100" />
                    </div>
